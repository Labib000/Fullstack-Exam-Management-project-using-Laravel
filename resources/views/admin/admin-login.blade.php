...
<head>
  <meta charset="UTF-8">
  <title>Admin Login | Techno Batanagar</title>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="loginTab">
              <form id="loginForm">
                ...
                <div class="mb-3 text-danger small" id="loginError"></div>
            ...
            <div class="tab-pane fade" id="signupTab">
              <form id="signupForm">
                ...
                <div class="mb-3 text-danger small" id="signupError"></div>
...
<script>
  ...
  loginForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (!data.success) {
        document.getElementById('loginError').textContent = data.result || "Login failed.";
      } else {
  ...
  signupForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (!data.success) {
        document.getElementById('signupError').textContent = data.result || "Signup failed.";
      } else {
        localStorage.setItem("admin_token", data.result.token);
